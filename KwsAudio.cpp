...
KwsAudio::KwsAudio()
{
//	kwsaduio.load_param("./kws_mdel_v2/cnn_kws_v2.param");	// 注意加载路径设置
//	kwsaduio.load_model("./kws_mdel_v2/cnn_kws_v2.bin");
}
...
/**
 * 初始化NCNN
 * @param protopath 原型路径
 * @param modelpath 模型路径
 */
void KwsAudio::init(const char *protopath, const char *modelpath){
    kwsaduio.load_param(protopath);
    kwsaduio.load_model(modelpath);
}
